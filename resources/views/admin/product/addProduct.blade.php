    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">添加产品信息</h1>
                    </div><!-- /.col -->
        ...
        <div class="card card-primary col-md-12">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="POST" action="{{url('admin/product/self')}}" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">产品名称</label>
                        <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="输入名称">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">产品主页链接</label>
                        <input type="text" name="target_url" class="form-control" id="exampleInputEmail1" placeholder="输入链接">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="exampleInputFile">上传pc端图片(注意尺寸)(如果有的话)</label>
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" name="pad_image" class="custom-file-input" id="exampleInputFile">
                                <label class="custom-file-label" for="exampleInputFile">选择文件</label>
                            </div>
                            <div class="input-group-append">
                                <span class="input-group-text" id="">只支持jpg、jpeg、png格式，最大2M</span>
                    ...
                    <div class="form-group">
                        <label for="exampleInputFile">上传移动端图片(注意尺寸)(如果有的话)</label>
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" name="phone_image" class="custom-file-input" id="exampleInputFile">
                                <label class="custom-file-label" for="exampleInputFile">选择文件</label>
                            </div>
                            <div class="input-group-append">
                                <span class="input-group-text" id="">只支持jpg、jpeg、png格式，最大2M</span>
