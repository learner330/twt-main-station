    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">添加通知信息</h1>
                    </div><!-- /.col -->
        ...
        <div class="card card-primary col-md-12">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="POST" action="{{url('admin/notice/self')}}" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">标题</label>
                        <input type="text" name="title" class="form-control" id="exampleInputEmail1" value="{{ old('title') }}" placeholder="输入标题">
                    </div>
                    <div class="form-group">
                        <label>标签</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="source" class="form-control" id="exampleInputEmail1"  placeholder="输入来源">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">内容</label>
                        <textarea type="text" name="content" class="form-control" id="exampleInputEmail1"></textarea>
                    </div>
                </div>
                <!-- /.card-body -->
