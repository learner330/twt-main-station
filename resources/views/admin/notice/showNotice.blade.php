    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">通知信息</h1>
                    </div><!-- /.col -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($data as $d)
                                        <tr>
                                            ...
                                            <td>{{$d->time}}</td>
                                            <td>
                                                <form method="POST" action="{{url('admin/notice/self')}}">
                                ...
                                <button type="button" onclick="window.location.href='{{url('admin/notice/self')}}'" class="btn btn-danger">
                                    添加
                                </button>
                            </div>
                            <!-- /.card-body -->
