    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">添加轮播图信息</h1>
                    </div><!-- /.col -->
        ...
        <div class="card card-primary col-md-12">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="POST" action="{{url('admin/league/self')}}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="display_order" class="form-control" id="exampleInputEmail1" value="{{ old('link') }}" placeholder="输入显示顺序">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputFile">上传图片(注意尺寸)</label>
