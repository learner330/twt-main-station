                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        <td>一级</td>
                                        <td>{{$data[$i]['name']}}</td>
                                        <td>{{$data[$i]['target_url']}}</td>
                                        <td>{{$data[$i]['position']}}</td>
                                        <td>
                                            {{--写删除的路由--}}
                                            <form method="POST" action="{{url('admin/navigation/firstNavigation')}}">
                                                <input type="hidden" name="_method" value="DELETE"/>
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                                                <input type="hidden" name="f_id" value="{{$data[$i]['id']}}">
                                                {{--写编辑的路由--}}
                                                <div class="btn-group">
                                                    <button type="button" onclick="window.location.href='{{url('admin/navigation/first', ['id'=>$data[$i]['id']])}}'" class="btn btn-sm btn-outline-info">
                                                        编辑
                                                    </button>
                                    ...
                                    <tr>
                                        <td>二级</td>
                                        <td>{{$data[$i][$j]['name']}}</td>
                                        <td>{{$data[$i][$j]['target_url']}}</td>
                                        <td>{{$data[$i][$j]['position']}}</td>
                                        <td>
                                            {{--写删除的路由--}}
                                            <form method="POST" action="{{url('admin/navigation/secondNavigation')}}">
                                                <input type="hidden" name="_method" value="DELETE">
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                                                <input type="hidden" name="s_id" value="{{$data[$i][$j]['id']}}">
                                                {{--写编辑的路由--}}
                                                <div class="btn-group">
                                                    <button type="button" onclick="window.location.href='{{url('admin/navigation/second',['id'=>$data[$i][$j]['id']])}}'" class="btn btn-sm btn-outline-info">
                                                        编辑
                                                    </button>
                                                    <button type="submit" onclick="return confirm('确定删除吗，将无法恢复？')" class="btn btn-sm btn-outline-danger">
                                                        删除
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            {{--写跳转添加页面的路由--}}
                                            <button type="button" onclick="window.location.href='{{url('admin/navigation/secondNavigation', ['fid'=>$data[$i]['id']])}}'" class="btn btn-sm btn-outline-primary">
                                                添加二级导航
                                            </button>
                                        </th>
                                    </tr>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{--写跳转添加页面的路由--}}
                                            <button type="button" onclick="window.location.href='{{url('admin/navigation/firstNavigation')}}'" class="btn btn-sm btn-outline-primary">
                                                添加一级导航
                                            </button>
                                        </td>
                                    </tr>
